...
* The notebook is configured with:
  ...
  - access to CYGNO cluster, condor queues, via the notebook terminal or via any computer by means of [dedicated container](https://github.com/CYGNUS-RD/mycondor)
